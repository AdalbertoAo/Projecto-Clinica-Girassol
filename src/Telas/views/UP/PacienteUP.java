 ...
 * @author HP
 */
public class PacienteUP extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nº de Identificação");
        ...
        jLabel14.setText("Cadastro de Paciente");

        jLabel15.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel15.setText("Informações Pessoais");

        jButton1.setBackground(new java.awt.Color(29, 163, 207));
        jButton1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setText("Cadastar Paciente");
